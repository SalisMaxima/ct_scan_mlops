...
variable "dvc_bucket_name" {
  description = "Base DVC storage bucket name (-dev will be appended)"
  type        = string
  default     = "dtu-mlops-dvc-storage-482907"
}

variable "models_bucket_name" {
  description = "Base models storage bucket name (-dev will be appended)"
  type        = string
  default     = "dtu-mlops-models-482907"
}

variable "drift_logs_bucket_name" {
  description = "Base drift logs bucket name (-dev will be appended)"
  type        = string
...
variable "cloud_run_service_name" {
  description = "Base Cloud Run service name (-dev will be appended)"
  type        = string
  default     = "ct-scan-api"
}
